...
export default function ChefSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed bottom-0 right-0 top-0 z-50 flex w-[82%] max-w-[340px] flex-col overflow-hidden rounded-l-[2rem] bg-white px-5 py-5 shadow-xl transition-transform duration-300 lg:bottom-6 lg:right-6 md:top-6 lg:w-[318px] lg:max-w-none lg:translate-x-0 lg:rounded-[1.6rem] lg:shadow-sm ${
